...
export class UpdateBlogComponent implements OnInit {
  ...
  get_blog_info(){
    this.blog_service.get_single_blog_admin(this.blog_id).subscribe((response:any)=>{
      this.blog_props.title = response.title;
      this.blog_props.content = response.body;
      this.blog_props.feature_image = response.imagesrc;
